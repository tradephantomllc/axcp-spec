...
const file_proto_axcp_proto_rawDesc = "" +
	"\n" +
	"\x10proto/axcp.proto\x12\taxcp.v0_1\"\x9a\x05\n" +
...
var (
	...
	file_proto_axcp_proto_rawDescData []byte
)

func file_proto_axcp_proto_rawDescGZIP() []byte {
	file_proto_axcp_proto_rawDescOnce.Do(func() {
		file_proto_axcp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_axcp_proto_rawDesc), len(file_proto_axcp_proto_rawDesc)))
	})
...
var file_proto_axcp_proto_goTypes = []any{
...
func file_proto_axcp_proto_init() {
	...
	file_proto_axcp_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_proto_axcp_proto_msgTypes[10].OneofWrappers = []any{
		(*CapabilityMessage_Offer)(nil),
		(*CapabilityMessage_Request)(nil),
		(*CapabilityMessage_Ack)(nil),
	}
	file_proto_axcp_proto_msgTypes[17].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_axcp_proto_rawDesc), len(file_proto_axcp_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
