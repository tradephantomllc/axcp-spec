...
const (
	...
	// Auth error codes (Secure Baseline)
	ErrorCode_AUTH_SIGNATURE_INVALID     ErrorCode = 10 // Ed25519 signature verification failed
	ErrorCode_AUTH_REPLAY_DETECTED       ErrorCode = 11 // replay attack detected (sequence/nonce reuse)
	...
	// Error code 16 reserved (was: DP_POLICY_CONFLICT, moved to Advanced/Enterprise)
	ErrorCode_AUTH_DID_INVALID       ErrorCode = 17 // sender DID invalid or unresolvable
	ErrorCode_AUTH_TIMESTAMP_EXPIRED ErrorCode = 18 // timestamp outside acceptable window
)
...
var (
	ErrorCode_name = map[int32]string{
		...
		8:  "MALFORMED_REQUEST",
		9:  "TOO_MANY_REQUESTS",
		10: "AUTH_SIGNATURE_INVALID",
		11: "AUTH_REPLAY_DETECTED",
		12: "PROFILE_MISMATCH",
		13: "PROFILE_UNSUPPORTED",
		14: "PROFILE_NEGOTIATION_FAILED",
		15: "MISSING_PATCH_RANGE",
		17: "AUTH_DID_INVALID",
		18: "AUTH_TIMESTAMP_EXPIRED",
	}
...
type AxcpEnvelope struct {
	...
	// Auth fields for Secure Baseline (profile ≥1)
	SenderDid        string `protobuf:"bytes,20,opt,name=sender_did,json=senderDid,proto3" json:"sender_did,omitempty"`                       // sender's DID (e.g., did:key:z...)
	TimestampMs      uint64 `protobuf:"varint,21,opt,name=timestamp_ms,json=timestampMs,proto3" json:"timestamp_ms,omitempty"`                // unix timestamp in milliseconds
	Sequence         uint64 `protobuf:"varint,22,opt,name=sequence,proto3" json:"sequence,omitempty"`                                         // monotonic sequence number for replay protection
	RecipientDid     string `protobuf:"bytes,23,opt,name=recipient_did,json=recipientDid,proto3" json:"recipient_did,omitempty"`              // optional: intended recipient DID for directed messages
	Signature        []byte `protobuf:"bytes,100,opt,name=signature,proto3" json:"signature,omitempty"`                                       // detached sig over auth transcript (profile ≥1)
...
func (x *AxcpEnvelope) GetSenderDid() string {
	if x != nil {
		return x.SenderDid
	}
	return ""
...
func (x *AxcpEnvelope) GetTimestampMs() uint64 {
	if x != nil {
...
func (x *AxcpEnvelope) GetSequence() uint64 {
	if x != nil {
		return x.Sequence
	}
	return 0
...
func (x *AxcpEnvelope) GetRecipientDid() string {
	if x != nil {
...
const file_axcp_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"axcp.proto\x12\taxcp.v0_1\"\x9d\x06\n" +
	...
	"\ttelemetry\x18\v \x01(\v2\x1c.axcp.v0_1.TelemetryDatagramH\x00R\ttelemetry\x12\x1d\n" +
	"\n" +
	"sender_did\x18\x14 \x01(\tR\tsenderDid\x12!\n" +
	"\ftimestamp_ms\x18\x15 \x01(\x04R\vtimestampMs\x12\x1a\n" +
	"\bsequence\x18\x16 \x01(\x04R\bsequence\x12#\n" +
	"\rrecipient_did\x18\x17 \x01(\tR\frecipientDid\x12\x1c\n" +
	...
	"\x12descriptor_version\x18\a \x01(\tR\x11descriptorVersionJ\x04\b\b\x10\t\"\\\n" +
	...
	"\x04json\x18\x01 \x01(\fR\x04json*\x9d\x03\n" +
	"\tErrorCode\x12\v\n" +
	...
	"\x11TOO_MANY_REQUESTS\x10\t\x12\x1a\n" +
	"\x16AUTH_SIGNATURE_INVALID\x10\n" +
	"\x12\x18\n" +
	"\x14AUTH_REPLAY_DETECTED\x10\v\x12\x14\n" +
	"\x10PROFILE_MISMATCH\x10\f\x12\x17\n" +
	"\x13PROFILE_UNSUPPORTED\x10\r\x12\x1e\n" +
	"\x1aPROFILE_NEGOTIATION_FAILED\x10\x0e\x12\x17\n" +
	"\x13MISSING_PATCH_RANGE\x10\x0f\x12\x14\n" +
	"\x10AUTH_DID_INVALID\x10\x11\x12\x1a\n" +
	"\x16AUTH_TIMESTAMP_EXPIRED\x10\x12B9Z7github.com/tradephantomllc/axcp-spec/sdk/go/internal/pbb\x06proto3"
...
var file_axcp_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_axcp_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_axcp_proto_goTypes = []any{
	(ErrorCode)(0),               // 0: axcp.v0_1.ErrorCode
	(DeltaOp_OpType)(0),          // 1: axcp.v0_1.DeltaOp.OpType
	(*AxcpEnvelope)(nil),         // 2: axcp.v0_1.AxcpEnvelope
	(*DeltaOp)(nil),              // 3: axcp.v0_1.DeltaOp
	(*ContextPatch)(nil),         // 4: axcp.v0_1.ContextPatch
	(*ContextGraphVersion)(nil),  // 5: axcp.v0_1.ContextGraphVersion
	(*SyncSubscribe)(nil),        // 6: axcp.v0_1.SyncSubscribe
	(*SyncRequest)(nil),          // 7: axcp.v0_1.SyncRequest
	(*RetryEnvelope)(nil),        // 8: axcp.v0_1.RetryEnvelope
	(*CapabilityOffer)(nil),      // 9: axcp.v0_1.CapabilityOffer
	(*CapabilityRequest)(nil),    // 10: axcp.v0_1.CapabilityRequest
	(*CapabilityAck)(nil),        // 11: axcp.v0_1.CapabilityAck
	(*CapabilityMessage)(nil),    // 12: axcp.v0_1.CapabilityMessage
	(*CapabilityDescriptor)(nil), // 13: axcp.v0_1.CapabilityDescriptor
	(*ProfileNegotiate)(nil),     // 14: axcp.v0_1.ProfileNegotiate
	(*ProfileAck)(nil),           // 15: axcp.v0_1.ProfileAck
	(*RoutePolicyMessage)(nil),   // 16: axcp.v0_1.RoutePolicyMessage
	(*SystemStats)(nil),          // 17: axcp.v0_1.SystemStats
	(*TokenUsage)(nil),           // 18: axcp.v0_1.TokenUsage
	(*TelemetryDatagram)(nil),    // 19: axcp.v0_1.TelemetryDatagram
	(*ErrorMessage)(nil),         // 20: axcp.v0_1.ErrorMessage
	(*McpJsonBlob)(nil),          // 21: axcp.v0_1.McpJsonBlob
	(*A2AJsonBlob)(nil),          // 22: axcp.v0_1.A2AJsonBlob
}
var file_axcp_proto_depIdxs = []int32{
	4,  // 0: axcp.v0_1.AxcpEnvelope.context_patch:type_name -> axcp.v0_1.ContextPatch
	12, // 1: axcp.v0_1.AxcpEnvelope.capability_msg:type_name -> axcp.v0_1.CapabilityMessage
	16, // 2: axcp.v0_1.AxcpEnvelope.route_msg:type_name -> axcp.v0_1.RoutePolicyMessage
	20, // 3: axcp.v0_1.AxcpEnvelope.error:type_name -> axcp.v0_1.ErrorMessage
	14, // 4: axcp.v0_1.AxcpEnvelope.profile_neg:type_name -> axcp.v0_1.ProfileNegotiate
	15, // 5: axcp.v0_1.AxcpEnvelope.profile_ack:type_name -> axcp.v0_1.ProfileAck
	8,  // 6: axcp.v0_1.AxcpEnvelope.retry_env:type_name -> axcp.v0_1.RetryEnvelope
	19, // 7: axcp.v0_1.AxcpEnvelope.telemetry:type_name -> axcp.v0_1.TelemetryDatagram
	1,  // 8: axcp.v0_1.DeltaOp.op:type_name -> axcp.v0_1.DeltaOp.OpType
	3,  // 9: axcp.v0_1.ContextPatch.ops:type_name -> axcp.v0_1.DeltaOp
	5,  // 10: axcp.v0_1.SyncSubscribe.from:type_name -> axcp.v0_1.ContextGraphVersion
	5,  // 11: axcp.v0_1.SyncRequest.missing_from:type_name -> axcp.v0_1.ContextGraphVersion
	4,  // 12: axcp.v0_1.RetryEnvelope.buffered_patches:type_name -> axcp.v0_1.ContextPatch
	13, // 13: axcp.v0_1.CapabilityOffer.desc:type_name -> axcp.v0_1.CapabilityDescriptor
	9,  // 14: axcp.v0_1.CapabilityMessage.offer:type_name -> axcp.v0_1.CapabilityOffer
	10, // 15: axcp.v0_1.CapabilityMessage.request:type_name -> axcp.v0_1.CapabilityRequest
	11, // 16: axcp.v0_1.CapabilityMessage.ack:type_name -> axcp.v0_1.CapabilityAck
	17, // 17: axcp.v0_1.TelemetryDatagram.system:type_name -> axcp.v0_1.SystemStats
	18, // 18: axcp.v0_1.TelemetryDatagram.tokens:type_name -> axcp.v0_1.TokenUsage
